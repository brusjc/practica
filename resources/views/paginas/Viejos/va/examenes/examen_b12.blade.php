...
<div class="row">
	<div class="col-7">
		<div class="comment-text">
			<p>{{html_entity_decode(trans('examenes.exaB1_texto1'))}} {{$datos['mes']}} {{$datos['ano']}} {{html_entity_decode(trans('examenes.exaB1_texto2'))}} {{$datos['mes']}} {{$datos['ano']}}  {{html_entity_decode(trans('examenes.exaB1_texto3'))}}</p>
			<p>{{html_entity_decode(trans('examenes.exaB1_texto4'))}}</p>
			<p>{{html_entity_decode(trans('examenes.exaB1_texto5'))}} {{$datos['mes']}} {{$datos['ano']}} {{html_entity_decode(trans('examenes.exaB1_texto6'))}}</p>
			<p>{{html_entity_decode(trans('examenes.exaB1_texto7'))}} {{$datos['mes']}} {{$datos['ano']}} {{html_entity_decode(trans('examenes.exaB1_texto8'))}}</p>
		</div>
	</div>
	<div class="col-5">
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h3>Nivel B1 {{$datos['mes']}} {{$datos['ano']}} - Probes usuario</h3>
				@if(Auth::guest())
