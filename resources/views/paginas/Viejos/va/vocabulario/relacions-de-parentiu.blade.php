...
@section('contentheader_title'){{ html_entity_decode(trans('vocabulario.parentesco_title') )}}@endsection

@section('contentheader_h1'){{ html_entity_decode(trans('vocabulario.parentesco_h1') )}}@endsection
    ...
    <div class="container-fluid">
	    <div class="row content">
	        ...
	        <div class="col-md-6 pt-5 order-1">
				<p>{{ trans('vocabulario.parentesco_texto1') }}</p>
				<p>{{ trans('vocabulario.parentesco_texto2') }}</p>
				<p>{{ trans('vocabulario.parentesco_texto3') }}</p>
				<p>{{ trans('vocabulario.parentesco_texto4') }}</p>
				<p>{{ trans('vocabulario.parentesco_texto5') }}</p>
	        </div>
        </div>
    </div>
</section>
