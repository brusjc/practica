...
@section('contentheader_title'){{ html_entity_decode(trans('vocabulario.cuinavideos_title') )}}@endsection

@section('contentheader_h1'){{ html_entity_decode(trans('vocabulario.cuinavideos_h1') )}}@endsection

@section('breadcrumb1')<a href="/vocabulario">{{ trans('<vocabulario class="vocabulario_breadcrumb"></vocabulario>') }}</a>@endsection
