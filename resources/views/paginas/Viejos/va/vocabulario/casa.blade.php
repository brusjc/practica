...
<section id="about" class="about">
    <div class="row content">
		...
		<p>{{ html_entity_decode(trans('vocabulario.casa_texto1') )}}</p>
		<p>{{ html_entity_decode(trans('vocabulario.casa_texto2') )}}</p>
        </div>
    </div>
</section>
...
<section class="about">
	<div class="row content">
		<div class="col-md-4 pt-5 order-2">
			<img class="img-fluid " src="/img/practicav/vocabulario/casa.svg" width="300px" title="{{ trans('vocabulario.casa_imgtitle20') }}" alt="{{ trans('vocabulario.casa_imgalt20') }}">
		</div>
...
<section class="about">
	<div class="row content">
		<div class="col-md-4 pt-5 order-1">
			<img class="img-fluid" src="/img/practicav/vocabulario/bany.svg" width="300px" title="{{ trans('vocabulario.casa_imgtitle100') }}" alt="{{ trans('vocabulario.casa_imgalt100') }}">
		</div>
...
<section class="about">
	<div class="row content">
		<div class="col-md-4 pt-5 order-2">
			<img class="img-fluid" src="/img/practicav/vocabulario/muebles.svg" width="300px" title="{{ trans('vocabulario.casa_imgtitle200') }}" alt="{{ trans('vocabulario.casa_imgalt200') }}">
		</div>
		<div class="col-md-8 pt-5 order-1">
...
<section class="about">
	<div class="row content">
		<div class="col-md-4 pt-5 order-2">
			<img class="img-fluid" src="/img/practicav/vocabulario/electrodomesticos.svg" width="300px" title="{{ trans('vocabulario.casa_imgtitle300') }}" alt="{{ trans('vocabulario.casa_imgalt300') }}">
		</div>
		<div class="col-md-8 pt-5 order-1">
