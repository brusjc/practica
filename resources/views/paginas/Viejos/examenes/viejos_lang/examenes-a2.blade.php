...
<section>
	<div class="row content h-100">
		<div class="col-md-4 pt-5 order-2 centraimg">
			<img class="img-fluid d-none d-sm-block" src="/img/practicav/examenes/examen_a2.svg" width="300px" title="{{ trans('examenes.A2_imgtitle20') }}" alt="{{ trans('examenes.A2_imgalt20') }}">
		</div>
		...
		<div class="col-lg-12 col-md-12">
			<div class="card">
				<div class="card-header">
					<h2>{{ trans('examenes.A2_titulo300') }}</h2>
