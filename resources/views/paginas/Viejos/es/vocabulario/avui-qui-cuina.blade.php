...
@section('contentheader_title'){{ html_entity_decode(trans('vocabulario.cuina_title') )}}@endsection
...
<section class="about">
	<div class="row content">
		<div class="col-md-4 pt-5 order-1">
			<center><img class="img-fluid d-none d-sm-block" src="/img/practicav/vocabulario/fruta.svg" width="300px" title="{{ trans('vocabulario.cuina_imgtitle20') }}" alt="{{ trans('vocabulario.cuina_imgalt20') }}"></center>
		</div>
