...
@section('descripcion'){{ html_entity_decode(trans('vocabulario.diasSemana_descripcion') )}}@endsection

@section('keywords'){{ html_entity_decode(trans('vocabulario.diasSemana_keywords') )}}@endsection
...
<div class="row">
	<div class="col-md-3">
        @if(!Auth::guest())
			<a href="/practicainicio/9"><button type="button" class="btn btn-block btn-primary btn-lg">Practica</button></a>
		@else
