...
@section('contentheader_title'){{ html_entity_decode(trans('vocabulario.teles_title') )}}@endsection

@section('contentheader_h1'){{ html_entity_decode(trans('vocabulario.teles_h1') )}}@endsection

@section('breadcrumb1')<a href="/vocabulario">{{ trans('vocabulario.vocabulario_breadcrumb') }}</a>@endsection

@section('descripcion'){{ html_entity_decode(trans('vocabulario.teles_descripcion') )}}@endsection

@section('keywords'){{ html_entity_decode(trans('vocabulario.teles_keywords') )}}@endsection
...
<div class="row">
	...
	<div class="col-md-3">
        @if(!Auth::guest())
			<a class="btn btn-block btn-primary btn-lg" href="/practicainicio/7">Practica</a>
		@else
