...
@section('contentheader_title'){{ html_entity_decode(trans('dictats.dictat200906mv_title') )}}@endsection

@section('contentheader_h1'){{ html_entity_decode(trans('dictats.dictat200906mv_h1') )}}@endsection
    ...
    <div class="container-fluid">
	    <div class="row content">
	        ...
	        <div class="col-md-7 pt-5 order-1 order-md-1" data-aos="fade-up">
				<p>{{ html_entity_decode(trans('dictats.dictat200906mv_texto11') )}}</p>
				<ul>
