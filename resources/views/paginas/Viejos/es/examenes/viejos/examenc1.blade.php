...
<div class="comment-text">
	<p>{{ trans('examenes.C1_texto4') }}</p>
	<p>{{ trans('examenes.C1_texto5') }} <a href="https://cvc.cervantes.es/ensenanza/biblioteca_ele/marco/" target="_blank">{{ trans('examenes.C1_texto6') }}</a></p>
</div>
