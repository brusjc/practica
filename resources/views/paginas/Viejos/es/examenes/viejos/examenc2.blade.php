...
<div class="comment-text">
	<p>{{ trans('examenes.C2_texto4') }}</p>
	<p>{{ trans('examenes.C2_texto5') }} <a href="https://cvc.cervantes.es/ensenanza/biblioteca_ele/marco/" target="_blank">{{ trans('examenes.C2_texto6') }}</a></p>
</div>
