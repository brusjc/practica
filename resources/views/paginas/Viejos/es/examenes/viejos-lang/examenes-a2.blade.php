...
<section>
	<div class="row content h-100">
		<div class="col-md-4 pt-5 order-2 centraimg">
			<img class="img-fluid d-none d-sm-block" src="/img/practicav/examenes/examen_a2.svg" width="300px" title="{{ trans('esexamenes.A2_imgtitle20') }}" alt="{{ trans('esexamenes.A2_imgalt20') }}">
		</div>
...
<section class="about">
	@if($pruebas)
		<h2>{{ trans('esexamenes.A2_titulo200') }}</h2>
