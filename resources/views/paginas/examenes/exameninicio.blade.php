...
@section('contentheader_title')
    Estructura del {{$examen['prueba']['nombre']}}
@endsection
								...
								@foreach($area['subarea'] as $key2=>$subarea)
							        <tr>
										...
										@if($subarea['contestadas']>=$subarea['total'])
											<td>
												{{$subarea['subtemanombre']['nombre']}}
											</td>
											<td>
												<a href="/examen/{{$subarea['id']}}">
													<div class="progress progress-xs">
											...
											<td class="text-center">
												<a href="/examen/{{$subarea['id']}}">{{$subarea['contestadas']}}/{{$subarea['total']}}</a>
											</td>
											<td class="text-center">
												<a href="/examen/{{$subarea['id']}}">{{$subarea['nota']}}</a>
											</td>
										@elseif($examen['prueba']['grado_id']==8 && $key1==0 && $key2==1)
											<td>
												<a href="/examenz/{{$subarea['id']}}">{{$subarea['subtemanombre']['nombre']}}</a>
											</td>
											<td>
											...
											<td class="text-center">
												<a href="/examenz/{{$subarea['id']}}">{{$subarea['contestadas']}}/{{$subarea['total']}}</a>
											</td>
											<td class="text-center">
												<a href="/examenz/{{$subarea['id']}}">{{$subarea['nota']}}</a>
											</td>
										...
										@else
											<td>
												<a href="/examen/{{$subarea['id']}}">{{$subarea['subtemanombre']['nombre']}}</a>
											</td>
											<td>
												<a href="/examen/{{$subarea['id']}}">
													<div class="progress progress-xs">
