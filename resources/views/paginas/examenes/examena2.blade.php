...
@section('descripcion')
    {{ trans('examenes.A2_descripcion') }}
@endsection

@section('keywords')
    {{ trans('examenes.A2_keywords') }}
@endsection
...
<div class="row">
	...
	<div class="col-7">
		<div class="comment-text">
			<p>{{ html_entity_decode(trans('examenes.A2_texto1') )}}</p>
			<p>{{ html_entity_decode(trans('examenes.A2_texto2') )}}</p>
			<p>{{ html_entity_decode(trans('examenes.A2_texto3') )}}</p>
		</div>
	</div>
</div>

<div class="comment-text">
	<p>{{ html_entity_decode(trans('examenes.A2_texto4') )}}</p>
	<p>{{ html_entity_decode(trans('examenes.A2_texto5') )}} <a href="https://cvc.cervantes.es/ensenanza/biblioteca_ele/marco/" target="_blank">{{ html_entity_decode(trans('examenes.A2_texto6') )}}</a></p>
</div>
