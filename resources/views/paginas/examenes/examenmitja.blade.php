...
@section('contentheader_title')
    {{ trans('examenes.mitja_title') }}
@endsection

@section('contentheader_h1')
    {{ trans('examenes.mitja_titulo1') }}
@endsection
...
@section('descripcion')
    {{ trans('examenes.mitja_descripcion') }}
@endsection

@section('keywords')
    {{ trans('examenes.mitja_keywords') }}
@endsection
...
<div class="row mt-5">
	<div class="comment-text">
		<p>{{ html_entity_decode(trans('examenes.mitja_texto1') )}}</p>
		<p>{{ html_entity_decode(trans('examenes.mitja_texto2') )}}</p>
		<p>{{ html_entity_decode(trans('examenes.mitja_texto3') )}}</p>
		<p>{{ html_entity_decode(trans('examenes.mitja_texto4') )}}</p>
	</div>
</div>
