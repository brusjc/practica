...
@section('contentheader_title')
    {{trans('examenes.exaA2_title')}} {{$datos['mes']}} {{$datos['ano']}} de la JQCV
@endsection

@section('contentheader_h1')
    {{trans('examenes.exaA2_h1')}} {{$datos['mes']}} {{$datos['ano']}} de la JQCV
@endsection
...
@section('descripcion')
    {{trans('examenes.exaA2_descripcion1')}} {{$datos['mes']}} {{$datos['ano']}} {{trans('examenes.exaA2_descripcion2')}} {{$datos['mes']}} {{$datos['ano']}} {{trans('examenes.exaA2_descripcion3')}} {{$datos['mes']}} {{$datos['ano']}} {{trans('examenes.exaA2_descripcion4')}}
@endsection

@section('keywords')
    {{trans('examenes.exaA2_keywords1')}} {{$datos['mes']}} {{$datos['ano']}} {{trans('examenes.exaA2_keywords2')}}
@endsection
