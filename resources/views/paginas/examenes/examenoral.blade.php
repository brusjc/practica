...
@section('descripcion')
    {{ trans('examenes.oral_descripcion') }}
@endsection

@section('keywords')
    {{ trans('examenes.oral_keywords') }}
@endsection

@section('main_content')

<div class="comment-text">
	<p>{{ html_entity_decode(trans('examenes.oral_texto1') )}}</p>
	<p>{{ html_entity_decode(trans('examenes.oral_texto2') )}}</p>
	<p>{{ html_entity_decode(trans('examenes.oral_texto3') )}}</p>
	<p>{{ html_entity_decode(trans('examenes.oral_texto4') )}}</p>
</div>
