...
@section('contentheader_title')
    Examen Mitja {{$datos['mes']}} {{$datos['ano']}} de la JQCV
@endsection
...
@section('breadcrumb2')
	<a href="/examenmitja">{{ trans('examenes.mitja_breadcrumb') }}</a>
@endsection

@section('descripcion')
    "Examen Mitja {{$datos['mes']}} {{$datos['ano']}} de la JQCV: practica el Examen Mitja de {{$datos['mes']}} {{$datos['ano']}} de la JQCV. Pots realitzar l examen del nivell Mitja de {{$datos['mes']}} del {{$datos['ano']}} de la JQCV com si estigueres en la mateixa prova."
@endsection

@section('keywords')
    "Examen Mitja {{$datos['mes']}} {{$datos['ano']}} de la JQCV, Examen Mitja de valencià, exàmens de la JQCV, Exàmens de valencià, Exàmens JQCV, probas JQCV, exàmens anteriors JQCV"
@endsection

@section('main_content')
	<p>En Examen Mitja de {{$datos['mes']}} {{$datos['ano']}} de la JQCV (Junta Qualificadora de Coneixements de Valencià), pots realitzar l'examen del nivell Mitja de {{$datos['mes']}} del {{$datos['ano']}} com si estigueres en la mateixa prova.</p>
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h3>Nivel Mitjà {{$datos['mes']}} {{$datos['ano']}} - Probes usuario</h3>
				@if(Auth::guest())
