...
<div class="col-md-12">
	<div class="card">
		...
		<div class="card-body">
			<a href="#" class="btn btn-info">A</a>
			<a href="#" class="btn btn-info">B</a>
			<a href="#" class="btn btn-info">C</a>
			<a href="#" class="btn btn-info">D</a>
			<a href="#" class="btn btn-info">E</a>
			<a href="#" class="btn btn-info">F</a>
			<a href="#" class="btn btn-info">G</a>
			<a href="#" class="btn btn-info">H</a>
			<a href="#" class="btn btn-info">I</a>
			<a href="#" class="btn btn-info">J</a>
			<a href="#" class="btn btn-info">K</a>
			<a href="#" class="btn btn-info">L</a>
			<a href="#" class="btn btn-info">M</a>
			<a href="#" class="btn btn-info">N</a>
			<a href="#" class="btn btn-info">O</a>
			<a href="#" class="btn btn-info">P</a>
			<a href="#" class="btn btn-info">Q</a>
			<a href="#" class="btn btn-info">R</a>
			<a href="#" class="btn btn-info">S</a>
			<a href="#" class="btn btn-info">T</a>
			<a href="#" class="btn btn-info">U</a>
			<a href="#" class="btn btn-info">V</a>
			<a href="#" class="btn btn-info">W</a>
			<a href="#" class="btn btn-info">X</a>
			<a href="#" class="btn btn-info">Y</a>
			<a href="#" class="btn btn-info">Z</a>
		</div>
	</div>		
</div>
...
<div class="row">
	<div class="col-10">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title">{{trans('noms.noms_tituloK')}}</h2>
			</div>
			<div class="box-body">
				<table class="table table-bordered" summary="tabla de {{trans('ortografia.byv_titulo2')}}">
					<thead>
...
<div class="row">
	<div class="col-10">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title">{{trans('noms.noms_tituloX')}}</h2>
			</div>
			<div class="box-body">
				<table class="table table-bordered" summary="tabla de {{trans('ortografia.byv_titulo2')}}">
					<thead>
