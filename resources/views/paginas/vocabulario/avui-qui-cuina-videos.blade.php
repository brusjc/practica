...
@section('contentheader_title')
	{{ html_entity_decode(trans('vocabulario.cuinavideos_titulo1') )}}
@endsection

@section('contentheader_h1')
	{{ html_entity_decode(trans('vocabulario.cuinavideos_h1') )}}
@endsection
...
@section('breadcrumb2')
	<a href="/avui-qui-cuina">{{ trans('vocabulario.cuina_breadcrumb') }}</a>
@endsection

@section('descripcion')
    {{ html_entity_decode(trans('vocabulario.cuinavideos_descripcion') )}}
@endsection

@section('keywords')
    {{ html_entity_decode(trans('vocabulario.cuinavideos_keywords') )}}
@endsection
