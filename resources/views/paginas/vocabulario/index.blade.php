        ...
        <div class="row">
            <div class="col-sm-3 center">
                <div class="service wow fadeInUp">
                    <a href="/{{session('locale')}}/el-nom-de-les-lletres">
            ...
            <div class="col-sm-3 center">
                <div class="service wow fadeInUp">
                    <a href="/{{session('locale')}}/parts-del-dia">
                        <div class="service-icon center">
            ...
            <div class="col-sm-3 center">
                <div class="service wow fadeInUp">
                    <a href="/{{session('locale')}}/dies-de-la-setmana">
                        <div class="service-icon center">
            ...
            <div class="col-sm-3 center">
                <div class="service wow fadeInUp">
                    <a href="/{{session('locale')}}/les-hores">
                        <div class="service-icon center">
            ...
            <div class="col-sm-3 center">
                <div class="service wow fadeInUp">
                    <a href="/{{session('locale')}}/cos-huma">
                        <div class="service-icon center">
            ...
            <div class="col-sm-3 center">
                <div class="service wow fadeInUp">
                    <a href="/{{session('locale')}}/avui-qui-cuina">
                        <div class="service-icon center">
            ...
            <div class="col-sm-3 center">
                <div class="service wow fadeInUp">
                    <a href="/{{session('locale')}}/parem-taula">
                        <div class="service-icon center">
            ...
            <div class="col-sm-3 center">
                <div class="service wow fadeInUp">
                    <a href="/{{session('locale')}}/entre-teles">
                        <div class="service-icon center">
            ...
            <div class="col-sm-3 center">
                <div class="service wow fadeInUp">
                    <a href="/{{session('locale')}}/mesos-any">
                        <div class="service-icon center">
            ...
            <div class="col-sm-3 center">
                <div class="service wow fadeInUp">
                    <a href="/{{session('locale')}}/relacions-de-parentiu">
                        <div class="service-icon center">
