...
@section('contentheader_title')
	{{ html_entity_decode(trans('vocabulario.meses_titulo1') )}}
@endsection

@section('contentheader_h1')
	{{ html_entity_decode(trans('vocabulario.meses_h1') )}}
@endsection
...
@section('descripcion')
    {{ html_entity_decode(trans('vocabulario.meses_descripcion') )}}
@endsection

@section('keywords')
    {{ html_entity_decode(trans('vocabulario.meses_keywords') )}}
@endsection
