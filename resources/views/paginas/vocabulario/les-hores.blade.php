...
@section('contentheader_title')
	{{ html_entity_decode(trans('vocabulario.horas_titulo1') )}}
@endsection

@section('contentheader_h1')
	{{ html_entity_decode(trans('vocabulario.horas_h1') )}}
@endsection
...
@section('descripcion')
    {{ html_entity_decode(trans('vocabulario.horas_descripcion') )}}
@endsection

@section('keywords')
    {{ html_entity_decode(trans('vocabulario.horas_keywords') )}}
@endsection
