...
@section('contentheader_title')
	{{ html_entity_decode(trans('vocabulario.numeros_titulo1') )}}
@endsection

@section('contentheader_h1')
	{{ html_entity_decode(trans('vocabulario.numeros_h1') )}}
@endsection
...
@section('descripcion')
    {{ html_entity_decode(trans('vocabulario.numeros_descripcion') )}}
@endsection

@section('keywords')
    {{ html_entity_decode(trans('vocabulario.numeros_keywords') )}}
@endsection
