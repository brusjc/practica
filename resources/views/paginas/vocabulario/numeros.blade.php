...
@section('contentheader_title'){{ html_entity_decode(trans('vocabulario.numeros_titulo1') )}}@endsection

@section('contentheader_h1'){{ html_entity_decode(trans('vocabulario.numeros_h1') )}}@endsection

@section('breadcrumb1')<a href="/vocabulario">{{ trans('vocabulario.vocabulario_breadcrumb') }}</a>@endsection

@section('descripcion'){{ html_entity_decode(trans('vocabulario.numeros_descripcion') )}}@endsection

@section('keywords'){{ html_entity_decode(trans('vocabulario.numeros_keywords') )}}@endsection
...
<div class="row">
	...
	<div class="col-7">
		<p>{{ html_entity_decode(trans('vocabulario.numeros_texto1') )}}</p>
		<p>{{ html_entity_decode(trans('vocabulario.numeros_texto2') )}}</p>
		<p>{{ html_entity_decode(trans('vocabulario.numeros_texto3') )}}</p>
		<p>{{ html_entity_decode(trans('vocabulario.numeros_texto4') )}}</p>
		<p>{{ html_entity_decode(trans('vocabulario.numeros_texto5') )}}</p>
	</div>
</div>
