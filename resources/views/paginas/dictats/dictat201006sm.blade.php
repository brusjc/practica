...
@section('contentheader_title'){{ trans('dictats.dictat201006sm_title') }}@endsection

@section('contentheader_h1'){{ trans('dictats.dictat201006sm_h1') }}@endsection

@section('breadcrumb0')<a href="/{{session('lang')}}/">Inicio</a>@endsection

@section('breadcrumb1')<a href="/{{session('lang')}}/dictats">{{ trans('dictats.dictats_breadcrumb') }}</a>@endsection

@section('breadcrumb2'){{ trans('dictats.dictat201006sm_breadcrumb') }}</a>@endsection

@section('descripcion'){{ trans('dictats.dictat201006sm_descripcion') }}@endsection

@section('keywords'){{ trans('dictats.dictat201006sm_keywords') }}@endsection
    ...
    <div class="container-fluid">
        <div class="row content h-100">
            ...
            <div class="col-md-7 pt-5 order-1 order-md-1" data-aos="fade-up">
    			<p>{{ trans('dictats.dictat201006sm_texto11') }}</p>
    			<ul>
