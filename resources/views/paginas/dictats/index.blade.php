...
@section('contentheader_title')
	{{ html_entity_decode(trans('dictats.dictats_title') )}}
@endsection

@section('contentheader_h1')
	{{ html_entity_decode(trans('dictats.dictats_h1') )}}
@endsection
...
@section('descripcion')
    {{ html_entity_decode(trans('dictats.dictats_descripcion') )}}
@endsection

@section('keywords')
    {{ html_entity_decode(trans('dictats.dictats_keywords') )}}
@endsection
