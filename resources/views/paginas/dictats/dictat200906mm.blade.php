...
@section('breadcrumb2'){{ trans('dictats.dictat200906mm_breadcrumb') }}</a>@endsection
        ...
        <div class="row content counts">
            ...
            <div class="col-md-10">
                <div class="box box-info">
                    <h2>{{ trans('dictats.dictat200906mm_titulo3') }}</h2>
                                ...
                                <div class="box box-solid">
                                    <div class="box-body">
                                        <div class="form-group">
                                          <textarea class="form-control" id="textoalumno" name="textoalumno" rows="5" placeholder="{{ trans('dictats.dictat200906mm_texto41') }}"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>                      
