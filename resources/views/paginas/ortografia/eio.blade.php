...
@section('contentheader_title')
	{{ html_entity_decode(trans('ortografia.eio_title') )}}
@endsection

@section('contentheader_h1')
	{{ html_entity_decode(trans('ortografia.eio_h1') )}}
@endsection
...
@section('descripcion')
    {{ html_entity_decode(trans('ortografia.eio_descripcion') )}}
@endsection

@section('keywords')
    {{ html_entity_decode(trans('ortografia.eio_keywords') )}}
@endsection
