...
@section('contentheader_title'){{ html_entity_decode(trans('ortografia.vocalisme_titulo1') )}}@endsection

@section('contentheader_h1'){{ html_entity_decode(trans('ortografia.vocalisme_titulo1') )}}@endsection
