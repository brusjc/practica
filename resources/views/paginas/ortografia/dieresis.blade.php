...
@section('contentheader_title')
	{{ html_entity_decode(trans('ortografia.dieresis_titulo1') )}}
@endsection

@section('contentheader_h1')
	{{ html_entity_decode(trans('ortografia.dieresis_h1') )}}
@endsection
...
@section('descripcion')
    {{ html_entity_decode(trans('ortografia.dieresis_descripcion') )}}
@endsection

@section('keywords')
    {{ html_entity_decode(trans('ortografia.dieresis_keywords') )}}
@endsection
