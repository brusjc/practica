            ...
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    <a href="/{{ session('lang') }}/examenes-jqcv">
                        ...
                        <h3>{{ trans('home.home_titulo7') }}</h3>
                        <p>{{ trans('home.home_texto7') }}</p>
                    </a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    <a href="/{{ session('lang') }}/vocabulario">
                        ...
                        <h3>{{ trans('home.home_titulo8') }}</h3>
                        <p>{{ trans('home.home_texto8') }}</p>
                    </a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    <a href="/{{ session('lang') }}/ortografia">
                        ...
                        <h3>{{ trans('home.home_titulo9') }}</h3>
                        <p>{{ trans('home.home_texto9') }}</p>
                    </a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    <a href="/{{ session('lang') }}/dictats">
                        ...
                        <h3>{{ trans('home.home_titulo10') }}</h3>
                        <p>{{ trans('home.home_texto10') }}</p>
                    </a>
                </div>
            </div>
        </div>
