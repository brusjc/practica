...
//Funciones para páginas de examenes JQCV
    ...
    public function pruebasjqcv($idm)
    {
        ...
        return view('paginas.examenes.index', compact('respuesta', 'urlblade', 'urlblade'));
    }
 
    public function pruebas_a1($idm)
    {
        $urlblade='examenes-a1';
        App::setLocale($idm);
        session(['locale' => $idm]);
        $miurl='/'.session('locale').'/'.$urlblade;
        ...
        return view('paginas.examenes.examenes-a1', compact('miurl', 'urlblade', 'urlblade'));
    }

    public function pruebas_a2($idm)
    {
        $urlblade='examenes-a2';
        App::setLocale($idm);
        session(['locale' => $idm]);
        ...
        //Paso 3: Redirigimos a la vista
        $miurl='/'.session('locale').'/examen-a2';
        return view('paginas.examenes.examenes-a2', compact('pruebas', 'codigo', 'miurl', 'urlblade'));
    }

    public function prueba_a2($idm, $codigo)
    {
        $urlblade='examen-a2/'.$codigo;
        App::setLocale($idm);
        session(['locale' => $idm]);
        $miurl='/'.session('locale').'/'.$urlblade;
        ...
        return view('paginas.examenes.examen-a2', compact('datos', 'examenes', 'codigo', 'urlblade', 'urlblade'));
    }

    public function pruebas_b1($idm)
    {
        $urlblade='examenes-b1';
        App::setLocale($idm);
        session(['locale' => $idm]);
        ...
        $miurl='/'.session('locale').'/examen-b1';
        //return $miurl;

        //Paso 3: Redirigimos a la vista
        return view('paginas.examenes.examenes-b1', compact('pruebas', 'codigo', 'miurl', 'urlblade', 'urlblade'));
    }

    public function prueba_b1($idm, $codigo)
    {
        $urlblade='examen-b1/'.$codigo;
        App::setLocale($idm);
        session(['locale' => $idm]);
        $miurl='/'.session('locale').'/'.$urlblade;
        ...
        //Paso 5: Redirigimos al blade
        return view('paginas.examenes.examen-b1', compact('datos', 'examenes', 'codigo', 'urlblade', 'urlblade'));
    }

    public function pruebas_b2($idm)
    {
        $urlblade='examenes-b2';
        App::setLocale($idm);
        session(['locale' => $idm]);
        ...
        $miurl='/'.session('locale').'/examen-b2';
        //return $miurl;

        //Paso 3: Redirigimos a la vista
        return view('paginas.examenes.examenes-b2', compact('pruebas', 'codigo', 'miurl', 'urlblade'));
    }

    public function prueba_b2($idm, $codigo)
    {
        $urlblade='examen-b2/'.$codigo;
        App::setLocale($idm);
        session(['locale' => $idm]);
        $miurl='/'.session('locale').'/'.$urlblade;
        ...
        //Paso 5: Redirigimos al blade
        return view('paginas.examenes.examen-b2', compact('datos', 'examenes', 'codigo', 'urlblade'));
    }

    public function pruebas_c1($idm)
    {
        $urlblade='examenes-c1';
        App::setLocale($idm);
        session(['locale' => $idm]);
        ...
        $miurl='/'.session('locale').'/examen-c1';
        //return $miurl;

        //Paso 3: Redirigimos a la vista
        return view('paginas.examenes.examenes-c1', compact('pruebas', 'codigo', 'miurl', 'urlblade'));
    }

    public function prueba_c1($idm, $codigo)
    {
        $urlblade='examen-c1/'.$codigo;
        App::setLocale($idm);
        session(['locale' => $idm]);
        $miurl='/'.session('locale').'/'.$urlblade;
        ...
        //Paso 5: Redirigimos al blade
        return view('paginas.examenes.examen-c1', compact('datos', 'examenes', 'codigo', 'urlblade'));
    }

    public function pruebas_c2($idm)
    {
        $urlblade='examenes-c2';
        App::setLocale($idm);
        session(['locale' => $idm]);
        ...
        $miurl='/'.session('locale').'/examen-c2';
        //return $miurl;

        //Paso 3: Redirigimos a la vista
        return view('paginas.examenes.examenes-c2', compact('pruebas', 'codigo', 'miurl', 'urlblade'));
    }

    public function prueba_c2($idm, $codigo)
    {
        $urlblade='examen-c2/'.$codigo;
        App::setLocale($idm);
        session(['locale' => $idm]);
        $miurl='/'.session('locale').'/'.$urlblade;
        ...
        //Paso 5: Redirigimos al blade
        return view('paginas.examenes.examen-c2', compact('datos', 'examenes', 'codigo', 'urlblade'));
    }

    public function pruebas_elemental($idm)
    {
        $urlblade='examenes-elemental';
        App::setLocale($idm);
        session(['locale' => $idm]);
        ...
        $miurl='/'.session('locale').'/examen-elemental';
        //return $miurl;

        //Paso 3: Redirigimos a la vista
        return view('paginas.examenes.examenes-elemental', compact('pruebas', 'codigo', 'miurl', 'urlblade'));
    }

    public function prueba_elemental($idm, $codigo)
    {
        $urlblade='examen-elemental/'.$codigo;
        App::setLocale($idm);
        session(['locale' => $idm]);
        $miurl='/'.session('locale').'/'.$urlblade;
        ...
        //Paso 5: Redirigimos al blade
        return view('paginas.examenes.examen-elemental', compact('datos', 'examenes', 'codigo', 'urlblade'));
    }

    public function pruebas_oral($idm)
    {
        $urlblade='examenes-oral';
        App::setLocale($idm);
        session(['locale' => $idm]);
        ...
        $miurl='/'.session('locale').'/examen-oral';
        //return $miurl;

        //Paso 3: Redirigimos a la vista
        return view('paginas.examenes.examenes-oral', compact('pruebas', 'codigo', 'miurl', 'urlblade'));
    }

    public function prueba_oral($idm, $codigo)
    {
        $urlblade='examen-oral/'.$codigo;
        App::setLocale($idm);
        session(['locale' => $idm]);
        $miurl='/'.session('locale').'/'.$urlblade;
        ...
        //Paso 5: Redirigimos al blade
        return view('paginas.examenes.examen-oral', compact('datos', 'examenes', 'codigo', 'urlblade'));
    }

    public function pruebas_mitja($idm)
    {
        $urlblade='examenes-mitja';
        App::setLocale($idm);
        session(['locale' => $idm]);
        ...
        $miurl='/'.session('locale').'/examen-mitja';
        //return $miurl;

        //Paso 3: Redirigimos a la vista
        return view('paginas.examenes.examenes-mitja', compact('pruebas', 'codigo', 'miurl', 'urlblade'));
    }

    public function prueba_mitja($idm, $codigo)
    {
        $urlblade='examen-mitja/'.$codigo;
        App::setLocale($idm);
        session(['locale' => $idm]);
        $miurl='/'.session('locale').'/'.$urlblade;
        ...
        //Paso 5: Redirigimos al blade
        return view('paginas.examenes.examen-mitja', compact('datos', 'examenes', 'codigo', 'urlblade'));
    }

    public function pruebas_superior($idm)
    {
        $urlblade='examenes-superior';
        App::setLocale($idm);
        session(['locale' => $idm]);
        ...
        $miurl='/'.session('locale').'/examen-superior';
        //return $miurl;

        //Paso 3: Redirigimos a la vista
        return view('paginas.examenes.examenes-superior', compact('pruebas', 'codigo', 'miurl', 'urlblade'));
    }

    public function prueba_superior($idm, $codigo)
    {
        $urlblade='examen-superior/'.$codigo;
        App::setLocale($idm);
        session(['locale' => $idm]);
        $miurl='/'.session('locale').'/'.$urlblade;
        ...
        //Paso 5: Redirigimos al blade
        return view('paginas.examenes.examen-superior', compact('datos', 'examenes', 'codigo', 'urlblade'));
    }
...
//**********
    ...
    public function MasterPruebaXId($id)
    {
        ...
        return view('paginas.master.examenmaster', compact('prueba', 'urlblade'));
    }
