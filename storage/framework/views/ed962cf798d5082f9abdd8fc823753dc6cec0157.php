...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="apellido1" class="col-md-4 col-form-label text-md-right"><?php echo e(trans('message.apellido1')); ?></label>

                            <div class="col-md-6">
                                <input id="apellido1" type="text" class="form-control <?php $__errorArgs = ['apellido1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="apellido1" value="<?php echo e(old('apellido1')); ?>" required autocomplete="Primer apellido" autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="apellido2" class="col-md-4 col-form-label text-md-right"><?php echo e(trans('message.apellido2')); ?></label>

                            <div class="col-md-6">
                                <input id="apellido2" type="text" class="form-control <?php $__errorArgs = ['apellido2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="apellido2" value="<?php echo e(old('apellido2')); ?>" autocomplete="Segundo apellido" autofocus>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/auth/register.blade.php ENDPATH**/ ?>