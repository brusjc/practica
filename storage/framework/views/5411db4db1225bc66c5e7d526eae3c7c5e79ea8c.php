...
<div class="comment-text">
	...
	<p><?php echo e(trans('examenes.elemental_texto3')); ?></p>
	<p><?php echo e(trans('examenes.elemental_texto4')); ?></p>
</div>
		...
		<?php if($pruebas['original']['status']['error']==0): ?>
			<?php $__currentLoopData = $pruebas['original']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$nivel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="col-lg-4 col-md-4">
					<a class="mb-2 btn btn-block btn-info" href="examen_elemental/<?php echo e($nivel['codigo']); ?>"><?php echo e($nivel['nombre']); ?></a>
				</div>
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h3>Nivel Elemental - Probes usuario</h3>
				<?php if(Auth::guest()): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/examenes/examenelemental.blade.php ENDPATH**/ ?>