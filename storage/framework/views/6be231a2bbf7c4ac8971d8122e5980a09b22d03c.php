    ...
    <div class="container-fluid">
        <div class="row content h-100">
            ...
            <div class="col-md-8 pt-5 order-2">
                <p><?php echo trans('examenes.exaB1_texto1', ['mes'=>$datos['mes'], 'ano'=>$datos['ano'] ]); ?> </p>
                <p><?php echo trans('examenes.exaB1_texto2'); ?></p>
                <p><?php echo trans('examenes.exaB1_texto3'); ?></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid">
        <div class="row content h-100">
            ...
            <div class="col-md-8 pt-5 order-1">
                ...
                <p><?php echo trans('examenes.exaB1_texto101', ['mes'=>$datos['mes'], 'ano'=>$datos['ano'] ]); ?> </p>
                <p><?php echo trans('examenes.exaB1_texto102', ['mes'=>$datos['mes'], 'ano'=>$datos['ano'] ]); ?> </p>
            </div>
        </div>
    </div>
</section>
