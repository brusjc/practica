		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<a href="#b" class="btn btn-info">B</a>
					<a href="#c" class="btn btn-info">C</a>
					<a href="#d" class="btn btn-info">D</a>
					<a href="#e" class="btn btn-info">E</a>
					<a href="#f" class="btn btn-info">F</a>
					<a href="#g" class="btn btn-info">G</a>
					<a href="#h" class="btn btn-info">H</a>
					<a href="#i" class="btn btn-info">I</a>
					<a href="#j" class="btn btn-info">J</a>
					<a href="#l" class="btn btn-info">L</a>
					<a href="#m" class="btn btn-info">M</a>
					<a href="#n" class="btn btn-info">N</a>
					<a href="#o" class="btn btn-info">O</a>
					<a href="#p" class="btn btn-info">P</a>
					<a href="#q" class="btn btn-info">Q</a>
					<a href="#r" class="btn btn-info">R</a>
					<a href="#s" class="btn btn-info">S</a>
					<a href="#t" class="btn btn-info">T</a>
					<a href="#u" class="btn btn-info">U</a>
					<a href="#v" class="btn btn-info">V</a>
					<a href="#w" class="btn btn-info">W</a>
					<a href="#y" class="btn btn-info">Y</a>
			...
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloA')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
								<tr>
									<th><?php echo e(trans('noms.noms_titulo3')); ?></th>
									<th><?php echo e(trans('noms.noms_titulo4')); ?></th>
									<th><?php echo e(trans('noms.noms_titulo5')); ?></th>
									<th><?php echo e(trans('noms.noms_titulo5')); ?></th>
								</tr>
							</thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloB')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloC')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloD')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloE')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloF')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloG')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloH')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloI')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloJ')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloL')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloM')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloN')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloO')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloP')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloQ')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloR')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloS')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloT')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloU')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloV')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloW')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloY')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
    ...
    <div class="container-fluid">
		...
		<div class="row">
			<div class="col-10">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('noms.noms_tituloZ')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="tabla de <?php echo e(trans('ortografia.byv_titulo2')); ?>">
							<thead>
...
<?php echo $__env->make('layouts.frontandia.general', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/noms/index.blade.php ENDPATH**/ ?>