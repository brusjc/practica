					...
					<div class="form-group">
						<div class="col-sm-12">
							<ul>
								...
								<p><input type="radio" name="mirespuesta" value="<?php echo e($resp['id']); ?>">
								<?php echo e($resp['respuesta']); ?></p>
								<br/>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</ul>	
						</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/examenes/examen.blade.php ENDPATH**/ ?>