...
<body>
  <?php echo $__env->make('frontend.comunes.esnav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div class="aos-init aos-animate" data-aos="zoom-out">
...
</html><?php /**PATH C:\xampp\htdocs\practica\resources\views/frontend/layouts/esfrontend.blade.php ENDPATH**/ ?>