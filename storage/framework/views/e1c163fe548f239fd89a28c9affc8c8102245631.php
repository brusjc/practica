...
<?php $__env->startSection('contentheader_title'); ?>
    Estructura del <?php echo e($examen['prueba']['nombre']); ?>
								...
								<?php $__currentLoopData = $area['subarea']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2=>$subarea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							        <tr>
										...
										<?php if($subarea['contestadas']>=$subarea['total']): ?>
											<td>
												<?php echo e($subarea['subtemanombre']['nombre']); ?>

											</td>
											<td>
												<a href="/examen/<?php echo e($subarea['id']); ?>">
													<div class="progress progress-xs">
											...
											<td class="text-center">
												<a href="/examen/<?php echo e($subarea['id']); ?>"><?php echo e($subarea['contestadas']); ?>/<?php echo e($subarea['total']); ?></a>
											</td>
											<td class="text-center">
												<a href="/examen/<?php echo e($subarea['id']); ?>"><?php echo e($subarea['nota']); ?></a>
											</td>
										<?php elseif($examen['prueba']['grado_id']==8 && $key1==0 && $key2==1): ?>
											<td>
												<a href="/examenz/<?php echo e($subarea['id']); ?>"><?php echo e($subarea['subtemanombre']['nombre']); ?></a>
											</td>
											<td>
												<a href="/examenz/<?php echo e($subarea['id']); ?>">
													<div class="progress progress-xs">
														<div class="progress-bar progress-bar-primary" style="width: <?php echo e($subarea['porcentaje']); ?>%"></div>
													</div>	
												</a>
											...
											<td class="text-center">
												<a href="/examenz/<?php echo e($subarea['id']); ?>"><?php echo e($subarea['contestadas']); ?>/<?php echo e($subarea['total']); ?></a>
											</td>
											<td class="text-center">
												<a href="/examenz/<?php echo e($subarea['id']); ?>"><?php echo e($subarea['nota']); ?></a>
											</td>
										...
										<?php else: ?>
											<td>
												<a href="/examen/<?php echo e($subarea['id']); ?>"><?php echo e($subarea['subtemanombre']['nombre']); ?></a>
											</td>
											<td>
												<a href="/examen/<?php echo e($subarea['id']); ?>">
													<div class="progress progress-xs">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/examenes/exameninicio.blade.php ENDPATH**/ ?>