...
<?php $__env->startSection('breadcrumb2'); ?><?php echo e(trans('dictats.dictat200906mm_breadcrumb')); ?></a><?php $__env->stopSection(); ?>
    ...
    <div class="container-fluid">
        <div class="row content h-100">
            ...
            <div class="col-md-7 pt-5 order-1 order-md-1" data-aos="fade-up">
    			<p><?php echo e(trans('dictats.dictat200906mm_texto11')); ?></p>
    			<ul>
    				<li><?php echo e(trans('dictats.dictat200906mm_texto12')); ?></li>
    				<li><?php echo e(trans('dictats.dictat200906mm_texto13')); ?></li>
    				<li><?php echo e(trans('dictats.dictat200906mm_texto14')); ?></li>
    			</ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row content h-100">
            ...
            <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-right">
    			<h2><?php echo e(trans('dictats.dictat200906mm_titulo1')); ?></h2>
    			<p><?php echo e(trans('dictats.dictat200906mm_texto21')); ?></p>
    			<ol>
    				<li><?php echo e(trans('dictats.dictat200906mm_texto22')); ?></li>
    				<audio src="/sonido/dictados/dictados200906mm.mp3" preload="none" controls></audio>
    				<li><?php echo e(trans('dictats.dictat200906mm_texto23')); ?></li>
    				<audio src="/sonido/dictados/dictados200906mmp.mp3" preload="none" controls></audio>
    				<li><?php echo e(trans('dictats.dictat200906mm_texto24')); ?></li>
    				<audio src="/sonido/dictados/dictados200906mm.mp3" preload="none" controls></audio>
    			</ol>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row content">
            <div class="col-12 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
    			<p><?php echo e(trans('dictats.dictat200906mm_texto31')); ?></p>
    			<p><?php echo e(trans('dictats.dictat200906mm_texto32')); ?></p>
            </div>
        </div>
    </div>
</section>
	    ...
	    <div class="row content counts">
			...
			<div class="col-md-10">
				<div class="box box-info">
					<h2><?php echo e(trans('dictats.dictat200906mm_titulo3')); ?></h2>
								...
								<div class="box box-solid">
									<div class="box-body">
										<div class="form-group">
						                  <textarea class="form-control" id="textoalumno" name="textoalumno" rows="5" placeholder="<?php echo e(trans('dictats.dictat200906mm_texto41')); ?>"></textarea>
						                </div>
									</div>
								</div>
							</div>						
...
<?php echo $__env->make('layouts.frontandia.general', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/dictats/dictat200906mm.blade.php ENDPATH**/ ?>