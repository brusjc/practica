...
<?php $__env->startSection('contentheader_title'); ?>
	<?php echo e(html_entity_decode(trans('vocabulario.parentesco_titulo1') )); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheader_h1'); ?>
	<?php echo e(html_entity_decode(trans('vocabulario.parentesco_h1') )); ?>
	...
	<div class="col-7">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title"><?php echo e(trans('vocabulario.parentesco_titulo2')); ?></h2>
			</div>
			<div class="box-body">
...
<div class="comment-text">
	<p><?php echo e(html_entity_decode(trans('vocabulario.parentesco_texto1') )); ?></p>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/vocabulario/les-relacions-convencionals-i-de-parentiu.blade.php ENDPATH**/ ?>