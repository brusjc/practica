...
<?php $__env->startSection('contentheader_title'); ?><?php echo e(trans('vocabulario.numeros_title')); ?><?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheader_h1'); ?><?php echo e(trans('vocabulario.numeros_h1')); ?><?php $__env->stopSection(); ?>
...
<?php $__env->startSection('descripcion'); ?><?php echo e(trans('vocabulario.numeros_descripcion')); ?><?php $__env->stopSection(); ?>

<?php $__env->startSection('keywords'); ?><?php echo e(trans('vocabulario.numeros_keywords')); ?><?php $__env->stopSection(); ?>
...
<section class="container justify">
    <div class="container-fluid">
        <div class="row content h-100">
			...
			<div class="col-md-7">
				<p><?php echo e(trans('vocabulario.numeros_texto1')); ?></p>
				<p><?php echo e(trans('vocabulario.numeros_texto2')); ?></p>
				<p><?php echo e(trans('vocabulario.numeros_texto3')); ?></p>
				<p><?php echo e(trans('vocabulario.numeros_texto4')); ?></p>
				<p><?php echo e(trans('vocabulario.numeros_texto5')); ?></p>
			</div>
		</div>
	</div>
</section>
    ...
    <div class="container-fluid">
		<div class="row content h-100">
			<div class="col-md-5">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('vocabulario.numeros_titulo2')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.numeros_titulo2')); ?>">
							<thead>
								<tr>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo3')); ?></th>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo4')); ?></th>
								</tr>
							</thead>
			...
			<div class="col-md-5">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('vocabulario.numeros_titulo5')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.numeros_titulo5')); ?>">
							<thead>
								<tr>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo3')); ?></th>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo4')); ?></th>
    ...
    <div class="container-fluid">
		<div class="row">
			<div class="col-md-5">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('vocabulario.numeros_titulo6')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.numeros_titulo6')); ?>">
							<thead>
								<tr>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo3')); ?></th>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo4')); ?></th>
			...
			<div class="col-md-5">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('vocabulario.numeros_titulo7')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.numeros_titulo7')); ?>">
							<thead>
								<tr>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo3')); ?></th>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo4')); ?></th>
    ...
    <div class="container-fluid">
		<div class="row">
			<div class="col-md-5">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('vocabulario.numeros_titulo8')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.numeros_titulo8')); ?>">
							<thead>
								<tr>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo3')); ?></th>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo4')); ?></th>
    ...
    <div class="container-fluid">
		<div class="row">
			<div class="col-md-5">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('vocabulario.numeros_titulo9')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.numeros_titulo9')); ?>">
							<thead>
								<tr>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo3')); ?></th>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo4')); ?></th>
			...
			<div class="col-md-5">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('vocabulario.numeros_titulo10')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.numeros_titulo10')); ?>">
							<thead>
								<tr>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo3')); ?></th>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo4')); ?></th>
    ...
    <div class="container-fluid">
		<div class="row">
			<div class="col-md-5">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('vocabulario.numeros_titulo11')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.numeros_titulo11')); ?>">
							<thead>
								<tr>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo3')); ?></th>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo4')); ?></th>
			...
			<div class="col-md-5">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('vocabulario.numeros_titulo12')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.numeros_titulo12')); ?>">
							<thead>
								<tr>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo3')); ?></th>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo4')); ?></th>
    ...
    <div class="container-fluid">
		<div class="row">
			<div class="col-md-5">
				<div class="card">
					<div class="card-header  with-border">
						<h2 class="box-title"><?php echo e(trans('vocabulario.numeros_titulo13')); ?></h2>
					</div>
					<div class="box-body">
						<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.numeros_titulo13')); ?>">
							<thead>
								<tr>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo3')); ?></th>
									<th scope="col"><?php echo e(trans('vocabulario.numeros_titulo4')); ?></th>
...
<?php echo $__env->make('layouts.frontandia.general', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/vocabulario/numeros.blade.php ENDPATH**/ ?>