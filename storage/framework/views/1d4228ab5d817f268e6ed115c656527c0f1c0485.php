  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container-fluid d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li><a href="/va/examenes-jqcv"><?php echo e(trans('message.examenes_JQCV')); ?></a></li>
          <li><a href="/va/vocabulario"><?php echo e(trans('message.vocabulario')); ?></a></li>
          <li><a href="/va/ortografia"><?php echo e(trans('message.ortografia')); ?></a></li>
          <li><a href="/va/dictats"><?php echo e(trans('dictats.dictats_url')); ?></a></li>
          <li><a href="/va/noms"><?php echo e(trans('message.nombres')); ?></a></li>
          <?php if(Auth::guest()): ?>
...
<?php /**PATH C:\xampp\htdocs\practica\resources\views/frontend/comunes/vanav.blade.php ENDPATH**/ ?>