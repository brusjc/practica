...
<?php $__env->startSection('contentheader_title'); ?><?php echo e(trans('examenes.mitja_title')); ?><?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheader_h1'); ?><?php echo e(trans('examenes.mitja_h1')); ?><?php $__env->stopSection(); ?>
...
<?php $__env->startSection('descripcion'); ?><?php echo e(trans('examenes.mitja_descripcion')); ?><?php $__env->stopSection(); ?>

<?php $__env->startSection('keywords'); ?><?php echo e(trans('examenes.mitja_keywords')); ?><?php $__env->stopSection(); ?>
    ...
    <div class="container-fluid">
        <div class="row content h-100">
            ...
            <div class="col-md-8 pt-5 order-2">
    			<p><?php echo trans('examenes.mitja_texto1'); ?></p>
    			<p><?php echo e(trans('examenes.mitja_texto2')); ?></p>
    			<p><?php echo trans('examenes.mitja_texto3'); ?></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid">
    	<div class="row content h-100">
    		<div class="col-md-4 pt-5 order-2 centraimg">
    			<img class="img-fluid d-none d-sm-block" src="/img/practicav/examenes/examen_mitja.svg" width="300px" title="<?php echo e(trans('examenes.mitja_imgtitle100')); ?>" alt="<?php echo e(trans('examenes.mitja_imgalt100')); ?>">
    		</div>
    		<div class="col-md-8 pt-5 order-1">
    			<h2><?php echo e(trans('examenes.mitja_titulo100')); ?></h2>
    			<p><?php echo trans('examenes.mitja_texto101'); ?></p>
    			<p><?php echo e(trans('examenes.mitja_texto102')); ?></p>
                <p><?php echo e(trans('examenes.mitja_texto103')); ?> <a href="/<?php echo e(session('lang')); ?>/examenes-c1"><?php echo e(trans('examenes.mitja_texto104')); ?></a> <?php echo e(trans('examenes.mitja_texto105')); ?> <a href="https://cvc.cervantes.es/ensenanza/biblioteca_ele/marco/" rel="nofollow" target="_blank"><?php echo e(trans('examenes.mitja_texto106')); ?></a></p>
    		</div>
    	</div>
    </div>
</section>
...
<section class="container justify">
    <div class="container-fluid">
        <?php if($pruebas): ?>
            <h2><?php echo e(trans('examenes.mitja_titulo200')); ?></h2>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2><?php echo e(trans('examenes.mitja_titulo300')); ?></h2>
                        <div class="text-left">
                            <?php if(Auth::guest()): ?>
...
<?php echo $__env->make('layouts.frontandia.general', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/examenes/examenes-mitja.blade.php ENDPATH**/ ?>