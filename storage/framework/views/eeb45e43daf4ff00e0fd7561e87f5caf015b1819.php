...
<?php $__env->startSection('contentheader_title'); ?>
	<?php echo e(html_entity_decode(trans('vocabulario.horas_titulo1') )); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheader_h1'); ?>
	<?php echo e(html_entity_decode(trans('vocabulario.horas_h1') )); ?>
...
<?php $__env->startSection('descripcion'); ?>
    <?php echo e(html_entity_decode(trans('vocabulario.horas_descripcion') )); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('keywords'); ?>
    <?php echo e(html_entity_decode(trans('vocabulario.horas_keywords') )); ?>
...
<div class="row">
	...
	<div class="col-7">
		<p><?php echo e(html_entity_decode(trans('vocabulario.horas_texto1') )); ?></p>
		<p><?php echo e(html_entity_decode(trans('vocabulario.horas_texto2') )); ?></p>
		<p><?php echo e(html_entity_decode(trans('vocabulario.horas_texto3') )); ?></p>
		<p><?php echo e(html_entity_decode(trans('vocabulario.horas_texto4') )); ?></p>
		<p><?php echo e(html_entity_decode(trans('vocabulario.horas_texto5') )); ?></p>
	</div>
</div>
	...
	<div class="col-8">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title"><?php echo e(trans('vocabulario.horas_titulo2')); ?></h2>
			</div>
			<div class="box-body">
...
<div class="row">
	<div class="col-8">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title"><?php echo e(trans('vocabulario.horas_titulo3')); ?></h2>
			</div>
			<div class="box-body">
...
<div class="row">
	<div class="col-8">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title"><?php echo e(trans('vocabulario.horas_titulo4')); ?></h2>
			</div>
			<div class="box-body">
...
<div class="row">
	<div class="col-8">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title"><?php echo e(trans('vocabulario.horas_titulo5')); ?></h2>
			</div>
			<div class="box-body">
...
<div class="row">
	<div class="col-8">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title"><?php echo e(trans('vocabulario.horas_titulo6')); ?></h2>
			</div>
			<div class="box-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/vocabulario/les-hores.blade.php ENDPATH**/ ?>