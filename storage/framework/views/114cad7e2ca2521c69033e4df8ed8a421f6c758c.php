...
<?php $__env->startSection('contentheader_title'); ?>
	<?php echo e(html_entity_decode(trans('vocabulario.teles_titulo1') )); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheader_h1'); ?>
	<?php echo e(html_entity_decode(trans('vocabulario.teles_h1') )); ?>
...
<?php $__env->startSection('descripcion'); ?>
    <?php echo e(html_entity_decode(trans('vocabulario.teles_descripcion') )); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('keywords'); ?>
    <?php echo e(html_entity_decode(trans('vocabulario.teles_keywords') )); ?>
...
<div class="row">
	...
	<div class="col-7">
		<p><?php echo e(html_entity_decode(trans('vocabulario.teles_texto1') )); ?></p>
		<p><?php echo e(html_entity_decode(trans('vocabulario.teles_texto2') )); ?></p>
		<p><?php echo e(html_entity_decode(trans('vocabulario.teles_texto3') )); ?></p>
		<p><?php echo e(html_entity_decode(trans('vocabulario.teles_texto4') )); ?></p>
		<p><?php echo e(html_entity_decode(trans('vocabulario.teles_texto5') )); ?></p>
	</div>
</div>
...
<div class="row">
	<div class="col-11">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title"><?php echo e(trans('vocabulario.teles_titulo2')); ?></h2>
			</div>
			<div class="box-body">
				<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.teles_titulo2')); ?>">
					<thead>
						<tr>
							<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
							<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
...
<div class="row">
	<div class="col-11">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title"><?php echo e(trans('vocabulario.teles_titulo3')); ?></h2>
			</div>
			<div class="box-body">
				<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.teles_titulo3')); ?>">
					<thead>
						<tr>
							<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
							<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
...
<div class="row">
	<div class="col-11">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title"><?php echo e(trans('vocabulario.teles_titulo4')); ?></h2>
			</div>
			<div class="box-body">
				<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.teles_titulo4')); ?>">
					<thead>
						<tr>
							<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
							<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
...
<div class="row">
	<div class="col-11">
		<div class="card">
			<div class="card-header  with-border">
				<h2 class="box-title"><?php echo e(trans('vocabulario.teles_titulo5')); ?></h2>
			</div>
			<div class="box-body">
				<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.teles_titulo5')); ?>">
					<thead>
						<tr>
							<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
							<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/vocabulario/entre-teles.blade.php ENDPATH**/ ?>