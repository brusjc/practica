    ...
    <div class="container-fluid">
        <div class="row content h-100">
            ...
            <div class="col-md-8 pt-5 order-2">
    			<p><?php echo trans('examenes.oral_texto1'); ?></p>
    ...
    <div class="container-fluid">
    	<div class="row content h-100">
    		<div class="col-md-4 pt-5 order-2 centraimg">
    			<img class="img-fluid d-none d-sm-block" src="/img/practicav/examenes/examen_oral.svg" width="300px" title="<?php echo e(trans('examenes.oral_imgtitle100')); ?>" alt="<?php echo e(trans('examenes.oral_imgalt100')); ?>">
    		</div>
    		<div class="col-md-8 pt-5 order-1">
    			<h2><?php echo e(trans('examenes.oral_titulo100')); ?></h2>
    			<p><?php echo trans('examenes.oral_texto101'); ?></p>
    			<p><?php echo e(trans('examenes.oral_texto102')); ?></p>
...
<section class="container justify">
    <div class="container-fluid">
        <?php if($pruebas): ?>
            <h2><?php echo e(trans('examenes.oral_titulo200')); ?></h2>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2><?php echo e(trans('examenes.oral_titulo300')); ?></h2>
                        <div class="text-left">
                            <?php if(Auth::guest()): ?>
...
<?php echo $__env->make('layouts.frontandia.general', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/examenes/examenes-oral.blade.php ENDPATH**/ ?>