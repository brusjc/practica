...
<div class="row">
	...
	<div class="col-7">
		<div class="comment-text">
			...
			<p><?php echo e(trans('examenes.C1_texto3')); ?></p>
		</div>
	</div>
</div>

<div class="comment-text">
	<p><?php echo e(trans('examenes.C1_texto4')); ?></p>
	<p><?php echo e(trans('examenes.C1_texto5')); ?> <a href="https://cvc.cervantes.es/ensenanza/biblioteca_ele/marco/" target="_blank"><?php echo e(trans('examenes.C1_texto6')); ?></a></p>
</div>
		...
		<?php if($pruebas['original']['status']['error']==0): ?>
			<?php $__currentLoopData = $pruebas['original']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$nivel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="col-lg-4 col-md-4">
					<a class="mb-2 btn btn-block btn-info" href="examen_c1/<?php echo e($nivel['codigo']); ?>"><?php echo e($nivel['nombre']); ?></a>
				</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/examenes/examenc1.blade.php ENDPATH**/ ?>