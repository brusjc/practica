...
<?php $__env->startSection('contentheader_title'); ?><?php echo e(trans('esexamenes.B2_title')); ?><?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheader_h1'); ?><?php echo e(trans('esexamenes.B2_h1')); ?><?php $__env->stopSection(); ?>
...
<?php $__env->startSection('descripcion'); ?><?php echo e(trans('esexamenes.B2_descripcion')); ?><?php $__env->stopSection(); ?>

<?php $__env->startSection('keywords'); ?><?php echo e(trans('esexamenes.B2_keywords')); ?><?php $__env->stopSection(); ?>
...
<section>
    <div class="row content h-100">
        ...
        <div class="col-md-8 pt-5 order-2">
			<p><?php echo trans('esexamenes.B2_texto1'); ?></p>
			<p><?php echo e(trans('esexamenes.B2_texto2')); ?></p>
			<p><?php echo trans('esexamenes.B2_texto3'); ?></p>
        </div>
    </div>
</section>
...
<section>
	<div class="row content h-100">
		<div class="col-md-4 pt-5 order-2 centraimg">
			<img class="img-fluid d-none d-sm-block" src="/img/practicav/examenes/examen_b2.svg" width="300px" title="<?php echo e(trans('esexamenes.B2_imgtitle100')); ?>" alt="<?php echo e(trans('esexamenes.B2_imgalt100')); ?>">
		</div>
		<div class="col-md-8 pt-5 order-1">
			<h2><?php echo e(trans('esexamenes.B2_titulo100')); ?></h2>
			<p><?php echo trans('esexamenes.B2_texto101'); ?></p>
			<p><?php echo e(trans('esexamenes.B2_texto102')); ?></p>
		</div>
	</div>
</section>
...
<section class="about">
	<?php if($pruebas): ?>
		<h2><?php echo e(trans('esexamenes.B2_titulo200')); ?></h2>
			...
			<?php if($pruebas['original']['status']['error']==0): ?>
				<?php $__currentLoopData = $pruebas['original']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$nivel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="col-lg-4 col-md-4">
						<a class="mb-2 btn btn-block btn-info pt-3 pb-3 mb-4" href="/es/examen-b2/<?php echo e($nivel['codigo']); ?>"><?php echo e($nivel['nombre']); ?></a>
					</div>
...
<?php echo $__env->make('frontend.layouts.esfrontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/es/examenes/examenes-b2.blade.php ENDPATH**/ ?>