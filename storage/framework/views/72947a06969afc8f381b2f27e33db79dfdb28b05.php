...
<?php $__env->startSection('contentheader_title'); ?>
	<?php echo e(html_entity_decode(trans('vocabulario.cuina_titulo1') )); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheader_h1'); ?>
	<?php echo e(html_entity_decode(trans('vocabulario.cuina_h1') )); ?>
...
<?php $__env->startSection('descripcion'); ?>
    <?php echo e(html_entity_decode(trans('vocabulario.cuina_descripcion') )); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('keywords'); ?>
    <?php echo e(html_entity_decode(trans('vocabulario.cuina_keywords') )); ?>
...
<?php $__env->startSection('main_content'); ?>
	...
	<div class="comment-text">
		<p><?php echo e(html_entity_decode(trans('vocabulario.cuina_texto1') )); ?></p>
	</div>
		...
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo2')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo2')); ?>">
					<thead>
						<tr>
	...
	<h3 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo14')); ?></h3>
	<div class="row mb-5">
		<div class="col-4">
		</div>	
		<div class="col-md-4">
			<a class="btn btn-block btn-primary btn-lg" href="/practicainicio/14"><?php echo e(trans('vocabulario.cuina_titulo14')); ?></a>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo3')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo3')); ?>">
						<thead>
							<tr>
							<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
							<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo4')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo4')); ?>">
						<thead>
							<tr>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo5')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo5')); ?>">
						<thead>
							<tr>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo6')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo6')); ?>">
						<thead>
							<tr>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo7')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo7')); ?>">
						<thead>
							<tr>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo8')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo8')); ?>">
						<thead>
							<tr>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo9')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo9')); ?>">
						<thead>
							<tr>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo10')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo10')); ?>">
						<thead>
							<tr>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo11')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo11')); ?>">
						<thead>
							<tr>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo12')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo12')); ?>">
						<thead>
							<tr>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
	...
	<div class="row">
		<div class="col-11">
			<div class="card">
				<div class="card-header  with-border">
					<h2 class="box-title"><?php echo e(trans('vocabulario.cuina_titulo13')); ?></h2>
				</div>
				<div class="box-body">
					<table class="table table-bordered" summary="<?php echo e(trans('vocabulario.cuina_titulo13')); ?>">
						<thead>
							<tr>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun1')); ?></th>
								<th scope="col-3"><?php echo e(trans('vocabulario.vocabulario_comun2')); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/vocabulario/avui-qui-cuina.blade.php ENDPATH**/ ?>