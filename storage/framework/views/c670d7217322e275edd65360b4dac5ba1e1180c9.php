...
<div class="row">
	...
	<div class="col-7">
		<div class="comment-text">
			<p><?php echo e(trans('examenes.A2_texto1')); ?></p>
...
<div class="comment-text">
	<p><?php echo e(trans('examenes.A2_texto4')); ?></p>
	<p><?php echo e(trans('examenes.A2_texto5')); ?> <a href="https://cvc.cervantes.es/ensenanza/biblioteca_ele/marco/" target="_blank"><?php echo e(trans('examenes.A2_texto6')); ?></a></p>
</div>
		...
		<?php if($pruebas['original']['status']['error']==0): ?>
			<?php $__currentLoopData = $pruebas['original']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$nivel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="col-lg-4 col-md-4">
					<a class="mb-2 btn btn-block btn-info" href="examen_a2/<?php echo e($nivel['codigo']); ?>"><?php echo e($nivel['nombre']); ?></a>
				</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/examenes/examena2.blade.php ENDPATH**/ ?>