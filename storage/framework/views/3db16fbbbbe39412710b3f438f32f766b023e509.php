...
<?php $__env->startSection('contentheader_title'); ?><?php echo e(trans('esexamenes.oral_title')); ?><?php $__env->stopSection(); ?>

<?php $__env->startSection('contentheader_h1'); ?><?php echo e(trans('esexamenes.oral_h1')); ?><?php $__env->stopSection(); ?>
...
<?php $__env->startSection('descripcion'); ?><?php echo e(trans('esexamenes.oral_descripcion')); ?><?php $__env->stopSection(); ?>

<?php $__env->startSection('keywords'); ?><?php echo e(trans('esexamenes.oral_keywords')); ?><?php $__env->stopSection(); ?>
...
<section>
    <div class="row content h-100">
        ...
        <div class="col-md-8 pt-5 order-2">
			<p><?php echo trans('esexamenes.oral_texto1'); ?></p>
			<p><?php echo e(trans('esexamenes.oral_texto2')); ?></p>
			<p><?php echo trans('esexamenes.oral_texto3'); ?></p>
        </div>
    </div>
</section>
...
<section>
	<div class="row content h-100">
		<div class="col-md-4 pt-5 order-2 centraimg">
			<img class="img-fluid d-none d-sm-block" src="/img/practicav/examenes/examen_oral.svg" width="300px" title="<?php echo e(trans('esexamenes.oral_imgtitle100')); ?>" alt="<?php echo e(trans('esexamenes.oral_imgalt100')); ?>">
		</div>
		<div class="col-md-8 pt-5 order-1">
			<h2><?php echo e(trans('esexamenes.oral_titulo100')); ?></h2>
			<p><?php echo trans('esexamenes.oral_texto101'); ?></p>
			<p><?php echo e(trans('esexamenes.oral_texto102')); ?></p>
			<p><?php echo trans('esexamenes.oral_texto103'); ?></p>
		</div>
	</div>
</section>
...
<section class="about">
	<?php if($pruebas): ?>
		<h2><?php echo e(trans('esexamenes.oral_titulo200')); ?></h2>
			...
			<?php if($pruebas['original']['status']['error']==0): ?>
				<?php $__currentLoopData = $pruebas['original']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$nivel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="col-lg-4 col-md-4">
						<a class="mb-2 btn btn-block btn-info pt-3 pb-3 mb-4" href="/es/examen-oral/<?php echo e($nivel['codigo']); ?>"><?php echo e($nivel['nombre']); ?></a>
					</div>
		...
		<div class="col-lg-12 col-md-12">
			<div class="card">
				<div class="card-header">
					<h2><?php echo e(trans('esexamenes.oral_titulo300')); ?></h2>
					<div class="text-left">
						<?php if(Auth::guest()): ?>
...
<?php echo $__env->make('frontend.layouts.esfrontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\practica\resources\views/paginas/es/examenes/examenes-oral.blade.php ENDPATH**/ ?>